...
class Player(pygame.sprite.Sprite):
    def __init__(self, game):
        ...
        self.pos = vec(50, HEIGHT - 200)
        self.vel = vec(0, 0)
        self.acc = vec(0, 0)

    def load_image(self):
        # "bunny2_hurt.png" x="411" y="1866" width="150" height="174"
    ...
    def animate(self):
        ...
        # если стоит и не прыгает
        #print(self.jumping, self.walking, self.vel.x, self.acc.x  )
